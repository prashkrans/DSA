/*
Algo: (Top Down Approach + Backtracking is used here)
Each word of the words array has two options either to fill horizontally or vertically.
The complex part is to manage the filling of words in the crossword as per the given
rules and bounds of the table. Also, the backtracking part must only deal with the current
word and should delete a character common to the previous word hence we use a placeArr
vector of bool data type.
*/
