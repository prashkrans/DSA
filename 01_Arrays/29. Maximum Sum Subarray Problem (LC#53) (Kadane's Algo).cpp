/* DP Prob. #29. (LC#53) - Maximum Sum Subarray Problem [Verified]
...
int kadane(vector<int> a) {
	int maxCurr = a[0], maxGlobal = a[0];		//	It is really important to initialize them both to a[0] else it gives an incorrect answer
