/* Queue Prob. #7. Graph Prob. #35.1. Minimum Steps to Reach a Target by a Knight
...
bool isValid(pair<int, int> v, int n) {                 //  It validates whether i and j are not out of bounds
    ...
    else return true;                                   //  I might have lost an opportunity with soroco because of not returning true here
}
