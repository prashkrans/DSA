...
//	Method 2. Double pass and using a/r, a, ar^2 with two unordered_maps (Easier to understand)
...
//	Method 3. Single pass and using a & ar and two unordered maps (Tricky)
