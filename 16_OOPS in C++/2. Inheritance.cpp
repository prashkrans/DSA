...
3.	Multiple inheritance:
	In multiple inheritance a class can inherit from more than one classes. i.e one sub class is inherited from more 
...
4.	Hierarchial inheritance: (Exact opposite of multiple inheritance)
...
5.	Hybrid (Virtual) inheritance:
	Hybrid Inheritance is implemented by combining more than one type of inheritance. For example: Combining Hierarchial inheritance and 
	Multiple Inheritance.
	
5b.	A special case of hybrid inheritance: Multipath inheritance: [#IMP]
	...
	can arrise in this type of inheritance. (Hierarchial followed by multiple inheritance)
	E.g. 	A
		  /   \
		 B     C
		   \  /
...
1.	Using a scope resolution operator (::) as shown in the above example [Prefer this]	
	Syntax: object.class_name::variable_name; or object.class_name::method_name();
2.	Using virtual base class for the base class due to which the ambiguity arises (Here, classA): 
