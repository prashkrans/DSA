...
public:
	...
	bool isCyclic() {
        unordered_map<T, pair<T, int>> subset;              	//  [#IMP] Using a subset map to identify disjoint sets that maps a node u to its parent and the rank of the set in which u is present
