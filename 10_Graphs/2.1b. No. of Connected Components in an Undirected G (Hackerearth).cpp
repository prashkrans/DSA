...
// 	The coding assessment for Samsung Research Institute, Bangalore (SRI-B) had a single Q based on the 
//	application of connected components (pair of circles intersecting or touching each other) which landed me a job there.
...
public:
	graph(int n) {
		visited.resize(n+1, 0);				// Since vertices vary from 1 to n (not 0 to n-1)
	}
